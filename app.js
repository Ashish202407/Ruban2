(function () {
  ...
  /* ══════════════════════════════════════════════════════════════
     LOGO BASE64 (removed — generic version)
     ══════════════════════════════════════════════════════════════ */
  ...
  function downloadPdfReport(inputs, result) {
    ...
    doc.setTextColor(17);
    doc.text("STARTUP VALUATION", m + 21, y + 7);
    doc.setFontSize(9);
    doc.setFont("helvetica", "normal");
    doc.setTextColor(100);
    doc.text("Calculator", m + 21, y + 12);
    ...
    doc.setFont("helvetica", "normal");
    doc.text("Startup Valuation Calculator", m, 286);
